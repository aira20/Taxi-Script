...
local locations = {
    ...
    verdant = {pos = Vector3.new(3785, 84, 1631), tpye = "safe"},
    ...
    beach = Vector3.new(1401, 80, 536), type = "safe"},
    rooftop = Vector3.new(3916, 226, -362), type = "safe"},
    mount = Vector3.new(4575, 1103, -1734), type = "safe"},
    flare = Vector3.new(5761, 1143, -3770), type = "safe"},
    tom = Vector3.new(5635, 245, -66), type = "safe"},
    gym = Vector3.new(5790, 449, -99), type = "safe"},
    ferry = Vector3.new(1587, 78, -119), type = "safe"},
    saloon = Vector3.new(-6122, 118, -1958), type = "safe"},
    cavern = Vector3.new(3313, 74, -430), type = "safe"},
    bluemoon = Vector3.new(-8007, 343, -1833), type = "safe"},
    fernhill = Vector3.new(2324, 84, 655), type = "safe"},
    golden = Vector3.new(-7012, 108, -1952), type = "safe"},
    copper = Vector3.new(-5848, 80, -2411), type = "safe"},
    grave = Vector3.new(3714, 228, -601), type = "safe"},
    polar = Vector3.new(5130, 1112, -2043), type = "safe"},
    glacial = Vector3.new(5114, 1124, -2691), type = "safe"},
    butter =  Vector3.new(4029, 226,-458), type = "safe"},
    kingmushroom = Vector3.new(9362, 524, -31920), type = "safe"},
    moon = Vector3.new(10161, 5,  -32077), type = "enclosed"},
    crescentshovel = Vector3.new(9950, -136, -32983), type = "safe"},
    symphony = Vector3.new(10936, 21, -32917), type = "enclosed"},
}
